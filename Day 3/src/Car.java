public class Car {
    ...
    public Car(int customMinSpeed, double customWeight, boolean customIsTheCarOn) { // here customMinSpeed is a local
                                                                                    // variable
        minSpeed = customMinSpeed;
        // customMinSpeed = minSpeed; // nothing is going to change though
        // customMinSpeed will become 0 which is the value of minSpeed, it is never
        // gonna be used.
        weight = customWeight;
